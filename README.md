...
<div align="center">
  ...
  <h3><b>Welcome to Family Triage project</b></h3>
...
```sh
 $ git clone https://github.com/otmaneechchafyky/family-triage.git
 $ cd family-triage
```
...
Feel free to check the [issues page](https://github.com/otmaneechchafyky/family-triage/issues).
...
I would like to thank Mr ayyoub Ajmi for his insights.
